...
class NodeManager(object):
    ...
    def start_manager(self,url_q,result_q):
        ...
        b=BaseManager(address=("",8001),authkey="baike")
        b.start()
        return b
	...
	#接收数据提取进程发送的关联的url
	if not conn_q.empty():
		urlManager.add_new_urls(conn_q.get())	
...
if __name__=='__main__':
    ...
    #创建第一个进程管理url地址
    urlManager_process=Process(target=node.url_Manager_proc,args=(url_q,conn_q,"https://baike.baidu.com/item/%E7%BD%91%E7%BB%9C%E7%88%AC%E8%99%AB"));
    #创建一个进程,数据提取进程
